...
namespace WorkSetter
{
    public partial class Report : Form
    {
        ...
        public Report(string deviceName, string operatorName, string dbName, DateTime dateFirst, DateTime dateLast, bool checkReceived)
        {
            InitializeComponent();
            dateBegin = dateFirst;
            dateEnd = dateLast;
        ...
        private void setAverages()
        {
            using (MySqlConnection localDbConnection = new MySqlConnection(pathToDBFile))
            {
                ...
                {
                    this.Close();
                    MessageBox.Show("Kayıtlı veri bulunamadı", "Sistem", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        }
